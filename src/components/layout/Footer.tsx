...
export function Footer() {
  const waUrl = `https://wa.me/573160179289?text=${encodeURIComponent('Hola! Visité su página web y me gustaría recibir información general sobre sus servicios de merchandising y productos.')}`;
    ...
    <footer className="bg-gray-900 text-gray-300 py-8 px-4">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              <span>+57 316 0179289</span>
            </a>
            {/* Email */}
            <a
              href="mailto:gerencia@keyglobal.com.co"
              className="flex items-center gap-2 text-sm hover:text-[#C1304D] transition-colors"
            >
              <Mail className="w-4 h-4" />
              <span>gerencia@keyglobal.com.co</span>
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <a
            href="https://instagram.com/keyglobal"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-sm hover:text-[#C1304D] transition-colors"
          >
